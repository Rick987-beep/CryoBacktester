"""
tests/ui/test_equity_service.py — equity_service unit tests.
"""
import pytest
...
def test_computes_for_non_top_n(tmp_path, monkeypatch):
    ...
    from backtester.core.results import GridResult, equity_metrics
...
def test_caches_on_result(tiny_grid_result, monkeypatch):
    ...
    import backtester.core.results as _results_mod
