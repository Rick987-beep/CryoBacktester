# Run 146 Marketing Package — tudysho combo `c33317c67db1`
...
| Field | Value |
|-------|-------|
| UI link | `http://localhost:5007/?tab=Combo+Detail&run=146&combo=c33317c67db1` |
| Strategy | `tudysho` |
...
- Entry 13:00 UTC, turbulence threshold 60
- Proximity stop: 4h buffer, $1,000 USD
...
```bash
python analysis/run146_marketing/build_marketing.py
```
