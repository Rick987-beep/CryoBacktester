...
# Optional portfolio cash-Greek limits (see docs/strategy_howto.md §5a):
#   from backtester.core.portfolio_risk import (
#       DEFAULT_INVESTOR_LIMITS, max_qty_within_limits,
#       portfolio_cash_greeks, unit_cash_greeks,
#   )
# Blueprint keeps fixed qty — do not enable size-to-budget here.
# Live consumer: workspace.strategies.theta_engine.v10
...
class BlueprintHowto:
    ...
    #
    # Qty is fixed (PARAM_GRID["qty"]).  To cap portfolio cash Greeks instead,
    # see docs/strategy_howto.md §5a and theta_engine_v10 (not wired here).
