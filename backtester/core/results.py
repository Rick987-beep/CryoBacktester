...
After construction, GridResult is fully self-contained. html_report.py reads
...
from backtester.research.robustness import deflated_sharpe_ratio, _robustness_stats
