"""
CLI: ingest Binance OHLC klines into backtester/indicators/data/ via hist_data.load_klines.

Example:
  python -m backtester.indicators.ingest_klines --symbol BTCUSDT --interval 1d --start 2020-01-01
"""
...
from backtester.indicators.hist_data import KLINE_DIR, load_klines
