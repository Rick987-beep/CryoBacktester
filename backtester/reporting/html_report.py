#!/usr/bin/env python3
"""
html_report.py — Strategy-agnostic self-contained HTML report generator.
...
from backtester.reporting.charts import (
...
def _wfo_section_html(wfo_result, account_size):
    ...
    from backtester.research.walk_forward import WFOResult  # local import to avoid circularity
...
def generate_html(strategy_name, result, n_intervals, runtime_s,
    ...
    Args:
        ...
        result:               GridResult from backtester.core.results
